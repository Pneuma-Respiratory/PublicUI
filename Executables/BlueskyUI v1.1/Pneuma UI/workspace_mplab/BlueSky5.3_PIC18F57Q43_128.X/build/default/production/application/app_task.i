...
# 135 "application/app_task.c"
#pragma pack()
# 199 "application/app_task.c"
...
bat_s:
    ...
    else if( (bat_adc < 3250) && (bat_adc >= 3120) ){
        bat_vol = 0x04;
    }
    else if( (bat_adc < 3120) && (bat_adc >= 3000) ){
        bat_vol = 0x03;
    }
    else if( (bat_adc < 3000) && (bat_adc >= 2750) ){
        bat_vol = 0x02;
    }
    else{
        bat_vol = 0x01;
    ...
    switch( s_spray_state )
    {
        ...
        case STATE_SPRAY_ACTIVE_DLY:
         ...
         if(cnt_delay_ini >= 20)
         {
                ...
                pwm_adc_max = 0;
                spray_intv = 1;
                current_frc = 23593 + 45*13 + ((40 >> 1) - 5)*13;
                max_frc = current_frc;
          ...
          if(cnt_delay_ini >= 10)
          {
              ADC_Start( channel_ANC6 );
                    ...
                    else
                    {
                        ...
                        if((pwm_adc_val >= 100*4) || (adc_error >= 3 ))
                        {
                            PWM_Stop();
                            do { LATAbits.LATA1 = 0; } while(0);
                            do { LATAbits.LATA0 = 0; } while(0);
        ...
        case STATE_SPRAY_SCAN :
            ...
            else
            {
                ...
                if(pwm_adc_val >= 140*4)
                {
                    cnt_alarm1B++;
                    if(pwm_adc_val >= 150*4)
                    {
                        cnt_alarm1A++;
                    }
                    if((cnt_alarm1A >= 1 ) || (cnt_alarm1B >= 2))
                    {
                        PWM_Stop();
                        do { LATAbits.LATA1 = 0; } while(0);
                        do { LATAbits.LATA0 = 0; } while(0);
         ...
         pwm_adc_val = ADC_Average( channel_ANC6 );
            ...
            else
            {
                ...
                if(cnt_adc_10 >= 10)
                {
                    ...
                    if((abs(pwm_adc_evg - pwm_set_adc) >= 35) && (uln_offset > 5))
                    {
                        cnt_alarm5++;
                    ...
                    if(uln_level > before_level)
                    {
                        if(pwm_adc_evg > pwm_set_adc + (uln_level - before_level)*7 + 35*4)
                        {
                            cnt_alarm2++;
                        }
                    }
                    else
                    {
                        ...
                        {
                            if(pwm_adc_evg > pwm_set_adc - (before_level - uln_level)*5 + 30*4)
                            {
                                cnt_alarm2++;
                            }
                        }
                        ...
                        {
                            if(pwm_adc_evg > pwm_set_adc - (before_level - uln_level)*4 + 25*4)
                            {
                                cnt_alarm2++;
                            }
                        }
                    ...
                    if(pwm_adc_evg >= 638 + 5)
                    {
                        cnt_adc_GT = 0;
                        cnt_adc_LT++;
                        if((pwm_adc_evg >= 638 + 8) || (cnt_adc_LT >= 5))
                        {
                            cnt_adc_LT = 0;
                            curt_adc_offset1 = (pwm_adc_evg - 638)/12;
                            ...
                            else
                            {
                                ...
                                {
                                    if((pwm_adc_evg >= 190*4) || (pwm_adc_evg >= 638 + 50))
                                    {
                                        cnt_alarm4++;
                                    }
                                    else
                    ...
                    {
                        if(pwm_adc_evg <= 638 - 3)
                        {
                            cnt_adc_LT = 0;
                            cnt_adc_GT++;
                            if((pwm_adc_evg <= 638 - 5) || (cnt_adc_GT >= 5))
                            {
                                cnt_adc_GT = 0;
                                pwm_set_adc = 638;
                                curt_adc_offset1 = (pwm_set_adc - pwm_adc_evg)/16;
                                if(curt_adc_offset1 < 1)
                                {
                                    curt_adc_offset1 = 1;
                                }
                    ...
                    if((cnt_alarm2 >= 4)||(cnt_alarm3 >= 3)||(cnt_alarm4 >= 5)||(cnt_alarm5 >= 3))
                    {
                        PWM_Stop();
                        do { LATAbits.LATA1 = 0; } while(0);
                        do { LATAbits.LATA0 = 0; } while(0);
...
static void CartTask_Process( void )
{
    ...
    p_user_info->unused_pct = 100;
    return;
# 2913 "application/app_task.c"
}

void cart_Detect( void )
{
# 2968 "application/app_task.c"
}
