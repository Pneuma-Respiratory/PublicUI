...
#define BATT_THR_1                   3250     // 3.95V --> 1.975V --> 3950
#define BATT_THR_2                   3120     // 3.75V --> 1.875V --> 3750
#define BATT_THR_3                   3000     // 3.6V  --> 1.8V   --> 3600
#define BATT_THR_4                   2750     // 3.3V  --> 1.65V  --> 3300
...
#define CURRENT_FOSC_INI         100*4		    // INI FOSC CURRENT COMPARE 0.6A PROTECT
                                                 
#define CURRENT_THR1A            150*4	        // current adc > THR1 1.05A  ,stop ejection
#define CURRENT_THR1B            140*4          // 0.95A 2 times protect
#define ALARM1A_COUNT             1              // TOTAL TIMES = ALARM1_COUNT  
#define ALARM1B_COUNT             2

#define UP_OFFSET               35*4             
#define DOWN_OFFSET1            30*4                           
#define DOWN_OFFSET2            25*4           
#define ALARM2_COUNT            4               // Continuous Times = ALARM2_COUNT

#define ALARM5_OFFSET          35              
#define ALARM5_OFFSET_MAX      80                       
#define ALARM5_COUNT           3               // continue GT SET_ADC_VAL + 20 && uln_level <= before_level
             
#define CURRENT_THR2             210*4         // 0.95A current adc > THR2  ,stop ejection ,Normal Mode
//#define CURRENT_THR2             250*4       // 0.95A current adc > THR2  ,stop ejection ,Test Mode
#define ALARM3_COUNT             3    
          
#define OVER_CURRENT             190*4         //4V,0.8A Protect value      ,Normal Mode
//#define OVER_CURRENT             200*4       //4V,0.8A Protect value        .Test Mode
#define ALARM4_COUNT             5              

//#define SET_ADC_VAL              190*4           //4V 0.88A 
//#define SET_ADC_VAL              160*4           //4V 0.75A    
//#define SET_ADC_VAL              140*4           //4V 0.66A

#define LEVEL_INI                0 
#define PWM_DUTY_MIN             25         
#define PWM_DUTY_MAX             0

#define CURT_H_OFFSET_STEP      16             // current ADC < SET_ADC_VAL , add Voltage Speed ; CURRENT RISE SLOWLY
#define CURT_L_OFFSET_STEP      12             // current ADC > SET_ADC_VAL , sub Voltage Speed ; CURRENT FALL QUICKYLY
...
#define ULN_IN5_ON()             IO_RB2_SetHigh()
#define ULN_IN5_OFF()            IO_RB2_SetLow()
#define ULN_IN6_ON()             IO_RB1_SetHigh()
#define ULN_IN6_OFF()            IO_RB1_SetLow()
