...
# 2 "<built-in>" 2
# 1 "application/hal_adc.c" 2
# 13 "application/hal_adc.c"
# 1 "application/hal_board_cfg.h" 1
# 14 "application/hal_board_cfg.h"
...
# 14 "application/hal_board_cfg.h" 2
...
# 13 "application/hal_adc.c" 2
# 30 "application/hal_adc.c"
volatile uint8_t adc_state = 0x00;
...
# 61 "application/hal_adc.c"
void ADC_Init( uint32_t adc_ch )
{
}
# 73 "application/hal_adc.c"
uint8_t ADC_Start( adcc_channel_t adc_ch )
{
    return 0;
}
...
# 109 "application/hal_adc.c"
__attribute__((inline)) void ADC_Stop( void )
{
 ADCON0bits.ADGO = 0;
}
