...
//----------------------------------------------------------------------
// AD9833
#define ADI_OE_PORT              GPIOB
#define ADI_OE_PIN               GPIO_PIN_14

#define ADI_FSYNC_PORT           GPIOB
#define ADI_FSYNC_PIN            GPIO_PIN_15
#define ADI_SDATA_PORT           GPIOA
#define ADI_SDATA_PIN            GPIO_PIN_9
#define ADI_SCLK_PORT            GPIOA
#define ADI_SCLK_PIN             GPIO_PIN_8
//----------------------------------------------------------------------
// ADC
...
#define ADC_BAT_CH               ADC_CHANNEL_9       // ADC1_IN9
...
#define VBAT_CN_PIN              GPIO_PIN_3

#define LED1R_PORT               GPIOA
#define LED1R_PIN                GPIO_PIN_12
...
#define SDP_TRIGER_THR           40
#define SDP_STOP_THR             10
#define SDP_RESTAR_THR           30

#define CURRENT_THR1             480		//current adc > 480 ,stop ejection
#define CURRENT_THR2             430
#define CURRENT_THR3             420
...
//-------------------------------------------------------------------------------
#define ADI_OE_OFF()           HAL_GPIO_WritePin( ADI_OE_PORT, ADI_OE_PIN, GPIO_PIN_SET )
#define ADI_OE_ON()            HAL_GPIO_WritePin( ADI_OE_PORT, ADI_OE_PIN, GPIO_PIN_RESET )
