...
#define INFO_S_BYTES           128
     
#define FLASHC_START           0x014400     // Bank-C: 0x014400
#define FLASHD_START           0x01C400     // Bank-D: 0x01C400
#define FLASH_B_BYTES          0x8000

#define SNV_USER_INFO_ITEM     0x01
#define SNV_USER_RECORD_ITEM   0x02
...
/*
void info_mem_read( uint32 *data, uint32 *flash_addr, uint16_t count  );
void info_mem_write( uint32 *data, uint32 *flash_addr, uint16_t count );

uint8_t save_info_mem( uint8_t *data, uint8_t length );
uint8_t save_record( uint8_t *data, uint8_t length );
*/
