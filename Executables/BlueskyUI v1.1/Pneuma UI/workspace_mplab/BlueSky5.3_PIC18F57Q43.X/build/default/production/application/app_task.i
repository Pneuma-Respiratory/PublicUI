...
# 1 "application/../mcc_generated_files/timer/tmr1.h" 1
# 36 "application/../mcc_generated_files/timer/tmr1.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\c99\\stdbool.h" 1 3
# 36 "application/../mcc_generated_files/timer/tmr1.h" 2
...
# 37 "application/../mcc_generated_files/timer/tmr1.h" 2

# 1 "application/../mcc_generated_files/timer/timer_interface.h" 1
# 42 "application/../mcc_generated_files/timer/timer_interface.h"
...
# 42 "application/../mcc_generated_files/timer/timer_interface.h" 2
...
# 38 "application/../mcc_generated_files/timer/tmr1.h" 2
...
# 55 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_Initialize(void);
# 64 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_Start(void);
# 73 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_Stop(void);
# 82 "application/../mcc_generated_files/timer/tmr1.h"
uint16_t Timer1_Read(void);
# 91 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_Write(size_t timerVal);
# 100 "application/../mcc_generated_files/timer/tmr1.h"
...
# 117 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_StartSinglePulseAcquisition(void);
# 126 "application/../mcc_generated_files/timer/tmr1.h"
...
# 152 "application/../mcc_generated_files/timer/tmr1.h"
_Bool Timer1_HasOverflowOccured(void);
# 161 "application/../mcc_generated_files/timer/tmr1.h"
void Timer1_GateISR(void);
# 23 "application/app_task.c" 2

# 1 "application/../mcc_generated_files/adc/adcc.h" 1
# 48 "application/../mcc_generated_files/adc/adcc.h"
...
# 80 "application/../mcc_generated_files/adc/adcc.h"
void ADCC_Initialize(void);
# 90 "application/../mcc_generated_files/adc/adcc.h"
void ADCC_StartConversion(adcc_channel_t channel);
# 100 "application/../mcc_generated_files/adc/adcc.h"
_Bool ADCC_IsConversionDone(void);
# 110 "application/../mcc_generated_files/adc/adcc.h"
adc_result_t ADCC_GetConversionResult(void);
# 120 "application/../mcc_generated_files/adc/adcc.h"
adc_result_t ADCC_GetSingleConversion(adcc_channel_t channel);
# 129 "application/../mcc_generated_files/adc/adcc.h"
__attribute__((inline)) void ADCC_StopConversion(void);
# 138 "application/../mcc_generated_files/adc/adcc.h"
...
# 179 "application/../mcc_generated_files/adc/adcc.h"
...
# 205 "application/../mcc_generated_files/adc/adcc.h"
...
# 222 "application/../mcc_generated_files/adc/adcc.h"
...
# 255 "application/../mcc_generated_files/adc/adcc.h"
...
# 289 "application/../mcc_generated_files/adc/adcc.h"
_Bool ADCC_HasErrorCrossedUpperThreshold(void);
# 299 "application/../mcc_generated_files/adc/adcc.h"
_Bool ADCC_HasErrorCrossedLowerThreshold(void);
# 308 "application/../mcc_generated_files/adc/adcc.h"
...
void ADCC_ISR(void);
# 24 "application/app_task.c" 2

# 1 "application/../mcc_generated_files/system/watchdog.h" 1
# 42 "application/../mcc_generated_files/system/watchdog.h"
...
# 42 "application/../mcc_generated_files/system/watchdog.h" 2
# 59 "application/../mcc_generated_files/system/watchdog.h"
void WWDT_Initialize(void);
# 68 "application/../mcc_generated_files/system/watchdog.h"
void WWDT_SoftEnable(void);
# 77 "application/../mcc_generated_files/system/watchdog.h"
...
# 94 "application/../mcc_generated_files/system/watchdog.h"
_Bool WWDT_TimeOutStatusGet(void);
# 103 "application/../mcc_generated_files/system/watchdog.h"
_Bool WWDT_WindowViolationStatusGet(void);
# 25 "application/app_task.c" 2

# 1 "application/hal_board_cfg.h" 1
# 16 "application/hal_board_cfg.h"
# 1 "application/../mcc_generated_files/system/pins.h" 1
# 718 "application/../mcc_generated_files/system/pins.h"
...
# 1 "C:/Program Files/Microchip/MPLABX/v6.05/packs/Microchip/PIC18F-Q_DFP/1.14.237/xc8\\pic\\include\\c99/stdint.h" 1 3
...
# 44 "application/hal_key.h"
typedef struct{
    uint8_t state;
    uint8_t event;
    uint16_t count;
}keyState_t;
# 90 "application/hal_key.h"
...
# 27 "application/app_task.c" 2

# 1 "application/app_task.h" 1
# 163 "application/app_task.h"
typedef struct
{
    uint16_t event;
    uint16_t interval;
...
# 118 "application/app_task.c"
#pragma pack()
# 182 "application/app_task.c"
uint8_t machine_state = 0x01;
...
static uint8_t uln_level = 0;
static uint8_t before_level = 0;

static uint8_t cnt_adc_LT = 0;
static uint8_t cnt_adc_GT = 0;
...
static uint8_t uart_rx_delay = 0;
static uint8_t uart_rx_cnt;

static uint16_t adc_tx_val;
uint16_t pwm_tx_adc[400];
...
bat_s:
    bat_vol_bk = bat_vol;
    ADC_Start( channel_ANC7 );
    while( adc_state == 0x01 );
    bat_adc = ADC_Average( channel_ANC7 );

    if ( bat_adc >= 3950 ){
        bat_vol = 0x05;
    }
    else if( (bat_adc < 3950) && (bat_adc >= 3750) ){
        bat_vol = 0x04;
    }
    else if( (bat_adc < 3750) && (bat_adc >= 3600) ){
        bat_vol = 0x03;
    }
    else if( (bat_adc < 3600) && (bat_adc >= 3300) ){
        bat_vol = 0x02;
    }
    else{
        bat_vol = 0x01;
    ...
    do { LATAbits.LATA5 = 1; } while(0); do { LATAbits.LATA3 = 1; } while(0); do { LATAbits.LATA4 = 1; } while(0);
    do { LATEbits.LATE0 = 1; } while(0); do { LATEbits.LATE1 = 1; } while(0); do { LATEbits.LATE2 = 1; } while(0);
...
void app_task_Init( void )
{
    ...
    pApp_Task->task_cartridge.event = 0x0000 | 0x0001;
...
void app_task_Callback( void )
{
 ...
 if ( pApp_Task->task_spray.event & 0x8000 ){
  ...
  pApp_Task->task_spray.interval = spray_intv;
    ...
    if ( pApp_Task->task_cartridge.event & 0x8000 ){
        pApp_Task->task_cartridge.event ^= 0x8000;
...
void ChargeTask_Process( void )
{
    ...
    {
        delay_ms(3);
        vbus_pin = PORTDbits.RD4;
        charge_pin = PORTDbits.RD5;
    ...
    switch( s_spray_state )
    {
        ...
        case STATE_SPRAY_ACTIVE_DLY:
         ...
         if(cnt_delay_ini >= 20)
         {
                ...
                pwm_adc_max = 0;
                spray_intv = 1;
                current_frc = 23593 + 43*13 + ((50 >> 1) - 5)*13;
                max_frc = current_frc;
         ...
         else
         {
          if(cnt_delay_ini >= 10)
          {
              ADC_Start( channel_ANC6 );
                    while( adc_state == 0x01 );
                    pwm_adc_val = ADC_Average( channel_ANC6 );
                    adc_tx_val = swap_16bits(pwm_adc_val);
                    if(cnt_delay_ini == 10)
                    {
                        pwm_freq_adc[pwm_adc_cnt] = pwm_adc_val;
                        pwm_tx_adc[pwm_adc_cnt] = adc_tx_val;
                        pwm_adc_cnt++;
                    }
# 1198 "application/app_task.c"
          }
         }
            break;
        case STATE_SPRAY_SCAN :
            ...
            while( adc_state == 0x01 );
            pwm_adc_val = ADC_Average( channel_ANC6 );
            if (pwm_adc_val > 1500) pwm_adc_val = 0;
            adc_tx_val = swap_16bits(pwm_adc_val);
            pwm_freq_adc[pwm_adc_cnt] = pwm_adc_val;
            pwm_tx_adc[pwm_adc_cnt] = adc_tx_val;
            pwm_adc_cnt++;
# 1235 "application/app_task.c"
        ...
        case STATE_SPRAY_INHALATION:
         ...
         cnt_adc_10++;
            if((current_index < 50) && (current_inc++ % current_rate == 0))
            {
         ...
         if(cnt_adc_10 >= 10)
         {
             ...
             pwm_adc_sum = 0;
                adc_tx_val = swap_16bits(pwm_adc_evg);
                ...
                {
                    if(pwm_adc_evg > before_pwm_adc + (uln_level - before_level)*15 + 40*4)
                    {
                        cnt_alarm2++;
                    }
                }
                ...
                {
                    if(pwm_adc_evg > before_pwm_adc + 30*4)
                    {
                        cnt_alarm2++;
                    }
                }
                if(pwm_adc_evg >= 210*4)
                {
                    cnt_alarm3++;
                }
             ...
             if(pwm_adc_evg >= 539 + 6)
          {
                    cnt_adc_GT = 0;
                    if(pwm_adc_evg >= 539 + 15)
                    {
                        cnt_adc_LT = 0;
                        curt_adc_offset1 = (pwm_adc_evg - 539)/32;
                        if(curt_adc_offset1 < 1)
                        {
                            curt_adc_offset1 = 1;
                        }
                        curt_adc_offset2 = (pwm_adc_evg -539)/32;
                        if(curt_adc_offset2 < 1)
                        {
                            curt_adc_offset2 = 1;
                        }
                        if(uln_level != 0)
                        ...
                        else
                        {
                            if(duty_set_val <= 40)
                            {
                                duty_set_val = duty_set_val + curt_adc_offset2;
                                if(duty_set_val >= 40)
                                {
                                    duty_set_val = 40;
                                }
                    ...
                    {
                        if(pwm_adc_evg < 539 + 10)
                        {
                            cnt_adc_LT++;
                        }
                        if((pwm_adc_evg >= 539 + 10) || (cnt_adc_LT >= 2))
                        {
                            cnt_adc_LT = 0;
                            if(duty_set_val <= 40)
                            {
                ...
                else
                {
                    if(pwm_adc_evg <= 539 - 6)
                    {
                        ...
                        if(pwm_adc_evg <= 539 - 15)
                        {
                            cnt_adc_GT = 0;
                            pwm_set_adc = 539;
                            curt_adc_offset1 = (pwm_set_adc - pwm_adc_evg)/64;
                            if(curt_adc_offset1 < 1)
                            {
                                curt_adc_offset1 = 1;
                            }
                            curt_adc_offset2 = (pwm_set_adc - pwm_adc_evg)/64;
                            if(curt_adc_offset2 < 1)
                            {
                                curt_adc_offset2 = 1;
                            }
                            ...
                            else
                            {
                                if(duty_set_val != 0)
                                {
                                    if(duty_set_val < curt_adc_offset2)
                                    {
                                        duty_set_val = 0;
                                    }
                                    else
                        ...
                        else
                        {
                            ...
                            if((pwm_adc_evg <= 539 -10) || (cnt_adc_GT >= 2))
                            {
                                cnt_adc_GT = 0;
                                if(duty_set_val != 0)
                                {
...
# 1521 "application/app_task.c"
            ...
            if(sdp_cnt >= 10)
            {
             ...
             if( sdp_value < sdp_value_max*25/100 )
             {
                    if(++sdp_thr > 0)
                    {
                     sdp_thr = 0;
...
static void CartTask_Process( void )
{
    ...
    p_user_info->unused_pct = 100;
    return;
# 1939 "application/app_task.c"
}

void cart_Detect( void )
{
# 1994 "application/app_task.c"
}
