...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
  ...
  GPIO_InitStruct.Pin = ADC_NTC1_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init( ADC_NTC1_PORT, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = ADC_NTC2_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init( ADC_NTC2_PORT, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    HAL_GPIO_DeInit( ADC_NTC1_PORT, ADC_NTC1_PIN );
    HAL_GPIO_DeInit( ADC_NTC2_PORT, ADC_NTC2_PIN );
