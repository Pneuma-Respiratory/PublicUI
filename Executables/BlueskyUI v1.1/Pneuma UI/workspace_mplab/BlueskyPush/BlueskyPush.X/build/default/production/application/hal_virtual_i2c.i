# 1 "application/hal_virtual_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "application/hal_virtual_i2c.c" 2
# 12 "application/hal_virtual_i2c.c"
...
# 12 "application/hal_virtual_i2c.c" 2
...
# 56 "application/../mcc_generated_files/adcc.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\c99\\stdbool.h" 1 3
# 56 "application/../mcc_generated_files/adcc.h" 2
...
# 14 "application/hal_virtual_i2c.c" 2
...
# 15 "application/hal_virtual_i2c.c" 2

# 1 "application/hal_virtual_i2c.h" 1
# 19 "application/hal_virtual_i2c.h"
# 1 "application/hal_virtual_i2c.h" 1
# 19 "application/hal_virtual_i2c.h" 2
# 52 "application/hal_virtual_i2c.h"
...
uint8_t atcab_wakeup( void );
# 16 "application/hal_virtual_i2c.c" 2
# 38 "application/hal_virtual_i2c.c"
uint8_t Device_Address;
# 48 "application/hal_virtual_i2c.c"
extern void I2C_DELAY( uint8_t delay_us );
# 58 "application/hal_virtual_i2c.c"
void VI2C_PIN_Cfg( void )
{


    do { TRISAbits.TRISA4 = 0; } while(0);
    do { ODCONAbits.ODCA4 = 1; } while(0);
    do { TRISAbits.TRISA5 = 0; } while(0);
    do { ODCONAbits.ODCA5 = 1; } while(0);

}
# 76 "application/hal_virtual_i2c.c"
void VI2C_DeInit( void )
{
...
void VI2C_WR_NAckBit( void )
{
    ...
    SCL_PIN_AS_OUTPUT();
    I2C_DELAY(10);
# 145 "application/hal_virtual_i2c.c"
    do { LATDbits.LATD1 = 0; } while(0);
    I2C_DELAY(10);
...
# 164 "application/hal_virtual_i2c.c"
...
# 224 "application/hal_virtual_i2c.c"
...
# 328 "application/hal_virtual_i2c.c"
uint8_t HalI2CWrite( uint8_t len, uint8_t *pBuf )
{
    uint8_t cnt, tmpAddr;
...
# 361 "application/hal_virtual_i2c.c"
uint8_t HalI2CRead( uint8_t len, uint8_t *pBuf )
{
