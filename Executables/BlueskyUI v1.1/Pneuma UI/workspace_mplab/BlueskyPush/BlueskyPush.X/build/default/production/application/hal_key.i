...
# 2 "<built-in>" 2
# 1 "application/hal_key.c" 2
# 12 "application/hal_key.c"
...
# 14 "application/hal_key.c" 2
# 34 "application/hal_key.c"
keyState_t KeyOn = { 0x00, 0x00, 0x00 };
# 62 "application/hal_key.c"
uint8_t halKeyScan( void )
{
    uint8_t pin, rslt;
    keyState_t *pKey;
    ...
    if ( pin ){
        ...
        if ( pKey->count > 80 ) rslt = 0x04;
        else rslt = 0x02;
    }
# 93 "application/hal_key.c"
    return rslt;
}
