...
# 2 "<built-in>" 2
# 1 "application/hal_led.c" 2
# 13 "application/hal_led.c"
# 1 "application/../mcc_generated_files/pin_manager.h" 1
# 54 "application/../mcc_generated_files/pin_manager.h"
...
# 5 "C:/Users/rapps/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.9.163/xc8\\pic\\include\\builtins.h" 2 3
...
# 235 "application/../application/app_task.h"
...
# 14 "application/hal_led.c" 2

# 1 "application/hal_board_cfg.h" 1
# 15 "application/hal_board_cfg.h"
...
# 15 "application/hal_board_cfg.h" 2
...
# 15 "application/hal_led.c" 2
# 30 "application/hal_led.c"
extern uint8_t led_AllOff;
# 64 "application/hal_led.c"
void HalLed_Init( void )
{
    do { LATAbits.LATA3 = 1; } while(0); do { TRISAbits.TRISA3 = 0; } while(0); do { ODCONAbits.ODCA3 = 1; } while(0);
    do { LATAbits.LATA4 = 1; } while(0); do { TRISAbits.TRISA4 = 0; } while(0); do { ODCONAbits.ODCA4 = 1; } while(0);
    do { LATAbits.LATA5 = 1; } while(0); do { TRISAbits.TRISA5 = 0; } while(0); do { ODCONAbits.ODCA5 = 1; } while(0);

    do { LATEbits.LATE0 = 1; } while(0); do { TRISEbits.TRISE0 = 0; } while(0); do { ODCONEbits.ODCE0 = 1; } while(0);
    do { LATEbits.LATE1 = 1; } while(0); do { TRISEbits.TRISE1 = 0; } while(0); do { ODCONEbits.ODCE1 = 1; } while(0);
    do { LATEbits.LATE2 = 1; } while(0); do { TRISEbits.TRISE2 = 0; } while(0); do { ODCONEbits.ODCE2 = 1; } while(0);

    do { LATCbits.LATC5 = 1; } while(0); do { TRISCbits.TRISC5 = 0; } while(0); do { ODCONCbits.ODCC5 = 1; } while(0);
    do { LATCbits.LATC4 = 1; } while(0); do { TRISCbits.TRISC4 = 0; } while(0); do { ODCONCbits.ODCC4 = 1; } while(0);
    do { LATDbits.LATD3 = 1; } while(0); do { TRISDbits.TRISD3 = 0; } while(0); do { ODCONDbits.ODCD3 = 1; } while(0);
    do { LATDbits.LATD2 = 1; } while(0); do { TRISDbits.TRISD2 = 0; } while(0); do { ODCONDbits.ODCD2 = 1; } while(0);
}
...
void hal_led_onoffCase(uint8_t led,uint8_t level)
{
    switch(led)
    {
        case 1:
            ...
            break;
        case 2:
            if(level) do { LATEbits.LATE0 = 0; } while(0);
            else do { LATEbits.LATE0 = 1; } while(0);
            break;
        case 3:
            if(level) do { LATEbits.LATE1 = 0; } while(0);
            else do { LATEbits.LATE1 = 1; } while(0);
            break;
        case 4:
            if(level) do { LATEbits.LATE2 = 0; } while(0);
            else do { LATEbits.LATE2 = 1; } while(0);
            break;
        case 5:
            if(level) do { LATCbits.LATC5 = 0; } while(0);
            else do { LATCbits.LATC5 = 1; } while(0);
            break;
        case 6:
            if(level) do { LATCbits.LATC4 = 0; } while(0);
            else do { LATCbits.LATC4 = 1; } while(0);
            break;
        case 7:
            if(level) do { LATDbits.LATD3 = 0; } while(0);
            else do { LATDbits.LATD3 = 1; } while(0);
            break;
        case 8:
            if(level) do { LATDbits.LATD2 = 0; } while(0);
            else do { LATDbits.LATD2 = 1; } while(0);
            break;
        default:
            break;
    }
