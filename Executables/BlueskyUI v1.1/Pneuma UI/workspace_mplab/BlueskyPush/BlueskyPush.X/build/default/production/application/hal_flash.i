...
# 2 "<built-in>" 2
# 1 "application/hal_flash.c" 2
# 1 "application/hal_flash.h" 1
# 34 "application/hal_flash.h"
...
# 1 "application/../mcc_generated_files/memory.h" 1
# 54 "application/../mcc_generated_files/memory.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.41\\pic\\include\\c99\\stdbool.h" 1 3
# 54 "application/../mcc_generated_files/memory.h" 2
# 99 "application/../mcc_generated_files/memory.h"
uint16_t FLASH_ReadWord(uint16_t flashAddr);
# 128 "application/../mcc_generated_files/memory.h"
void FLASH_WriteWord(uint16_t flashAddr, uint16_t *ramBuf, uint16_t word);
# 164 "application/../mcc_generated_files/memory.h"
int8_t FLASH_WriteBlock(uint16_t writeAddr, uint16_t *flashWordArray);
# 189 "application/../mcc_generated_files/memory.h"
void FLASH_EraseBlock(uint16_t startAddr);
# 222 "application/../mcc_generated_files/memory.h"
void DATAEE_WriteByte(uint16_t bAdd, uint8_t bData);
# 248 "application/../mcc_generated_files/memory.h"
uint8_t DATAEE_ReadByte(uint16_t bAdd);
# 2 "application/hal_flash.c" 2
...
uint8_t is_mem_full(){
    if (cur_flash_address >= 0x8000 - sizeof(info_shot_t)) return 1;
    else return 0;
}
