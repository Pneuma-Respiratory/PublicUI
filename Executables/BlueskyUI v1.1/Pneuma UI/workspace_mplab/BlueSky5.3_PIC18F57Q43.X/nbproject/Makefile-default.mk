...
FINAL_IMAGE=${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/application/hal_board_cfg.p1: application/hal_board_cfg.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit4   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=require -DCURRENT_TARGET=${CURRENT_TARGET} -DCURRENT_PROTECTION_EN=${CURRENT_PROTECTION_EN} -DVOLTAGE_REG_EN=${VOLTAGE_REG_EN} -DBRIDGE_VT=${BRIDGE_VT} -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/application/hal_board_cfg.p1 application/hal_board_cfg.c 
...
${OBJECTDIR}/application/hal_board_cfg.p1: application/hal_board_cfg.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/application/hal_board_cfg.p1.d 
	@${RM} ${OBJECTDIR}/application/hal_board_cfg.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=require -DCURRENT_TARGET=${CURRENT_TARGET} -DCURRENT_PROTECTION_EN=${CURRENT_PROTECTION_EN} -DVOLTAGE_REG_EN=${VOLTAGE_REG_EN} -DBRIDGE_VT=${BRIDGE_VT} -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/application/hal_board_cfg.p1 application/hal_board_cfg.c 
	@-${MV} ${OBJECTDIR}/application/hal_board_cfg.d ${OBJECTDIR}/application/hal_board_cfg.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/application/hal_board_cfg.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=pickit4  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=require -DCURRENT_TARGET=${CURRENT_TARGET} -DCURRENT_PROTECTION_EN=${CURRENT_PROTECTION_EN} -DVOLTAGE_REG_EN=${VOLTAGE_REG_EN} -DBRIDGE_VT=${BRIDGE_VT} -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=require -DCURRENT_TARGET=${CURRENT_TARGET} -DCURRENT_PROTECTION_EN=${CURRENT_PROTECTION_EN} -DVOLTAGE_REG_EN=${VOLTAGE_REG_EN} -DBRIDGE_VT=${BRIDGE_VT} -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/BlueSky5.3_PIC18F57Q43.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
