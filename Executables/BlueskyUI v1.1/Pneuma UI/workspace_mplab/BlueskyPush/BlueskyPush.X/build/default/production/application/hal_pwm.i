...
# 2 "<built-in>" 2
# 1 "application/hal_pwm.c" 2
# 12 "application/hal_pwm.c"
# 1 "application/../mcc_generated_files/nco1.h" 1
# 54 "application/../mcc_generated_files/nco1.h"
...
# 54 "application/../mcc_generated_files/nco1.h" 2
...
# 13 "application/hal_pwm.c" 2
# 56 "application/hal_pwm.c"
void PWM_Setup( uint8_t freq, uint8_t idx )
{
 if ( freq == 0x01 ){
    }
