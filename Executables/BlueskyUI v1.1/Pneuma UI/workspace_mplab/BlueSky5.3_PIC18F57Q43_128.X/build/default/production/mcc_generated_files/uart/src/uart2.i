...
# 43 "mcc_generated_files/uart/src/../../system/../uart/uart3.h"
# 1 "mcc_generated_files/uart/src/../../system/system.h" 1
...
# 44 "mcc_generated_files/uart/src/../../system/../uart/uart3.h" 2
...
static volatile uint8_t uart2RxBuffer[(32)];
static volatile uart2_status_t uart2RxStatusBuffer[(32)];
...
void (*UART2_ErrorInterruptHandler)(void);
static void (*UART2_CommunicationErrorInterruptHandler)(void);
...
void UART2_Initialize(void)
{
    ...
    PIE8bits.U2EIE = 0;
    UART2_ErrorInterruptHandler = UART2_ErrorISR;
...
size_t UART2_ErrorGet(void)
{
    uart2RxLastError.status = uart2RxStatusBuffer[(uart2RxTail + 1) & ((32) - 1)].status;
...
void UART2_ErrorISR(void)
{
    ...
    if(UART2_CommunicationErrorInterruptHandler != ((void*)0))
    {
        (*UART2_CommunicationErrorInterruptHandler)();
    }
...
void UART2_ErrorCallbackRegister(void (* callbackHandler)(void))
{
    if(((void*)0) != callbackHandler)
    {
        UART2_CommunicationErrorInterruptHandler = callbackHandler;
    }
}
