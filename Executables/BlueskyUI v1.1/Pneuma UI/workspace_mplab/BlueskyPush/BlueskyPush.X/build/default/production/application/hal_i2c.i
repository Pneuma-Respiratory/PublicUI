...
# 2 "<built-in>" 2
# 1 "application/hal_i2c.c" 2
# 11 "application/hal_i2c.c"
...
uint8_t atcab_wakeup( void );
# 14 "application/hal_i2c.c" 2
# 28 "application/hal_i2c.c"
...
# 59 "application/hal_i2c.c"
uint8_t Hal_I2C_Select( uint8_t device )
{

    if ( device == 0x01 ){
     Device_Address_Write = 0x38;
    }
    else if ( device == 0x03 ){
     Device_Address = 0x21;
     Device_Address_Write = 0x21 << 1;
     Device_Address_Read = (0x21 << 1) + 1;
    }
    else if ( device == 0x04 ){
     Device_Address = 0x00;
     ...
     Device_Address = (0xC8 >> 1);
  Device_Address_Write = (0xC8 >> 1) << 1;
  Device_Address_Read = ((0xC8 >> 1) << 1) + 1;
    }
    else{
        return 0x10;
    }
