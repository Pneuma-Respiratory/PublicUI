...
# 678 "./mcc_generated_files/pin_manager.h"
...
void gpio_Init( void )
{
    ...
    do { ODCONAbits.ODCA1 = 0; } while(0);
    do { LATAbits.LATA1 = 0; } while(0);


    do { ANSELCbits.ANSC0 = 0; } while(0);
    do { TRISCbits.TRISC0 = 0; } while(0);
    do { ODCONCbits.ODCC0 = 0; } while(0);
    do { LATCbits.LATC0 = 0; } while(0);


    do { ANSELDbits.ANSD6 = 0; } while(0);
    do { TRISDbits.TRISD6 = 1; } while(0);
    do { WPUDbits.WPUD6 = 0; } while(0);
    do { LATDbits.LATD6 = 1; } while(0);


    do { ANSELDbits.ANSD7 = 0; } while(0);
    do { TRISDbits.TRISD7 = 1; } while(0);
    do { WPUDbits.WPUD7 = 1; } while(0);
    do { LATDbits.LATD7 = 1; } while(0);

    do { TRISDbits.TRISD4 = 1; } while(0);
    do { WPUDbits.WPUD4 = 0; } while(0);
    do { ANSELDbits.ANSD4 = 1; } while(0);
    do { LATDbits.LATD4 = 0; } while(0);


    do { TRISDbits.TRISD5 = 1; } while(0);
    do { WPUDbits.WPUD5 = 0; } while(0);
    do { ANSELDbits.ANSD5 = 1; } while(0);
