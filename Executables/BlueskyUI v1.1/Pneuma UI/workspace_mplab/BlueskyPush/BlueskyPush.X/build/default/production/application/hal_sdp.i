...
# 2 "<built-in>" 2
# 1 "application/hal_sdp.c" 2
# 12 "application/hal_sdp.c"
...
# 12 "application/hal_sdp.c" 2

# 1 "application/hal_i2c.h" 1
# 16 "application/hal_i2c.h"
...
# 14 "application/hal_sdp.c" 2
# 27 "application/hal_sdp.c"
uint8_t pressureBuf[3];
# 41 "application/hal_sdp.c"
static uint8_t HalSdp_Read( void );
static uint8_t xCal_crc( uint8_t *ptr, uint8_t len );
# 53 "application/hal_sdp.c"
static uint8_t HalSdp_Reset( void )
{
    uint8_t result;
    Hal_I2C_Select( 0x04 );
    result = HalSensorWriteReg( 0x06, ((void*)0), 0 );
    Hal_I2C_Release( 0x04 );
...
# 85 "application/hal_sdp.c"
static uint8_t HalSdp_Command( uint16_t cmd )
{
    uint8_t data, result;
    Hal_I2C_Select( 0x03 );
    data = (uint8_t)cmd;
    result = HalSensorWriteReg( (uint8_t)(cmd >> 8), &data, 1 );
    Hal_I2C_Release( 0x03 );
...
uint8_t HalSdp_Start_Measure( void )
{
    return HalSdp_Command( 0x3615 );
}

uint8_t HalSdp_Stop_Measure( void )
{
    uint8_t result;
    HalSdp_Command( 0x3FF9 );
    delay_ms(2);
...
uint8_t HalSdp_GetID( void )
{
    ...
    if ( HalSdp_Command( 0x367C ) ){
         if ( HalSdp_Command( 0xE102 ) ){
