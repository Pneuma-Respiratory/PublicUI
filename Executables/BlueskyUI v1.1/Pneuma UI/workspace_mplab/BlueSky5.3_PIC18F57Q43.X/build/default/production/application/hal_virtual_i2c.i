...
# 13 "application/hal_virtual_i2c.c"
...
# 13 "application/hal_virtual_i2c.c" 2
...
# 37 "application/hal_virtual_i2c.c"
uint8_t Device_Address;
# 47 "application/hal_virtual_i2c.c"
extern void I2C_DELAY( uint8_t delay_us );
# 57 "application/hal_virtual_i2c.c"
void VI2C_PIN_Cfg( void )
{
...
# 75 "application/hal_virtual_i2c.c"
void VI2C_DeInit( void )
{
...
void VI2C_WR_NAckBit( void )
{
    ...
    SCL_PIN_AS_OUTPUT();
    I2C_DELAY(10);
# 144 "application/hal_virtual_i2c.c"
    do { LATDbits.LATD1 = 0; } while(0);
    I2C_DELAY(10);
...
# 163 "application/hal_virtual_i2c.c"
...
# 223 "application/hal_virtual_i2c.c"
...
# 327 "application/hal_virtual_i2c.c"
uint8_t HalI2CWrite( uint8_t len, uint8_t *pBuf )
{
    uint8_t cnt, tmpAddr;
...
# 360 "application/hal_virtual_i2c.c"
uint8_t HalI2CRead( uint8_t len, uint8_t *pBuf )
{
